...
## Acceptance Criteria
- [ ] Client state machine maintains an accurate set of favorited song IDs.
- [ ] Event listeners update DOM elements when favorites are toggled.
- [ ] Automated tests verify frontend logic and API contract.
