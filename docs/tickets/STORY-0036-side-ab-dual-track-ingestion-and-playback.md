...
## Acceptance Criteria
- [x] Users can upload Side B (Instrumental) + optional Side A (Vocal) directly via Stem Studio.
- [x] Side A/B tracks are created immediately with `status: completed` and `progress: 100%` (bypassing AI separation tasks).
- [x] Users can attach Side A to an existing Side B song via Song Details modal.
...
- [x] TASK-0075: Dual-Stream WebAudio Hot-Swapping & Dynamic Vocal Toggles
