...
## Summary
Upgrades Stem Studio with direct audio URL downloads, multi-file batch upload with asynchronous sequential FIFO separation, collapsible sidebar accordions, expanded Studio Song Catalog modal, smart Title/Artist filename parser, persistent header scratchpad notes, combined .zip stem & lyrics export, in-library song deletion, and post-separation input audio archiving.
